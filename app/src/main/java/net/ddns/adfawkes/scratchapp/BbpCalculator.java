...
public class BbpCalculator implements IPiCalculator {
    ...
    private MathContext context = new MathContext(1024, RoundingMode.HALF_EVEN);

    @Override
    public BigDecimal calculateTo(int digits) { return pi(digits); }
